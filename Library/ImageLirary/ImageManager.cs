...
namespace ImageLibrary
{
    public  class Images
    {
        ...
        internal static string serverPath = HttpContext.Current.Server.MapPath("~/Content");
        internal static string mainImage = serverPath + "/Products/Big/";
        ...
        public static string GetImageName(string extention)
        {
        ...
        {
            return HttpContext.Current.Server.MapPath("~/Content/Products/"+ name);
        }

        public static string GetFlashPath(string name)
        {
            return HttpContext.Current.Server.MapPath("~/Content/Products/Flash/" + name);
        }
    }
}
